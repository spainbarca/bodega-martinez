...
{{--            />--}}
            ...
            @if ($brands->count())
                <table class="table-auto w-full text-gray-600">
                    ...
                    <tr class="text-left">
                        <th class="py-2 px-2 w-full">Nombre</th>
                        ...
                        <tr>
                            ...
                            <td class="py-2">
                                <div class="flex divide-x divide-gray-300 font-semibold">
                                    <a class="px-2 hover:text-blue-600 cursor-pointer" wire:click="edit('{{$brand->id}}')">Editar</a>
                                    <a class="px-2 hover:text-red-600 cursor-pointer" wire:click="$emit('deleteBrand', '{{$brand->id}}')">Eliminar</a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
